// app/solutions/ingredients/page.tsx
...
export default function IngredientCheckingPage() {
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="text-center md:text-left">
        ...
        <h1 className="text-6xl font-bold text-white leading-tight mb-6">
          Instant ingredient checks means cleaner choices for your family
        </h1>
        <p className="text-lg text-gray-300 mb-8">
          Our intuitive scanning process quickly flags ingredients and provides clear, actionable information, empowering you to make informed decisions that protect your family.
        </p>
        ...
        <ul className="space-y-3 text-gray-400 text-left">
          ...
          <li className="flex items-center"><CheckIcon /> A curated marketplace of healthy products (coming soon)</li>
        </ul>
      </div>
      {/* Right Column: Image */}
      <div>
        <Image src="https://placehold.co/500x1000/000000/FFFFFF/png?text=Ingredient+Checker" width={500} height={1000} alt="Ingredient Checker App" className="rounded-2xl mx-auto" />
      </div>
    </div>
  );
}