    ...
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="text-center md:text-left">
        ...
        <h1 className="text-6xl font-bold text-white leading-tight mb-6">
          Olive makes going dairy-free easy. Scan labels, skip the guesswork
        </h1>
        <p className="text-lg text-gray-300 mb-8">
          Protect your family’s health with confidence by identifying hidden dairy-based additives in everyday products, before they ever make it into your cart.
        </p>
      ...
      {/* Right Column: Image */}
      <div>
        <Image src="https://placehold.co/500x1000/000000/FFFFFF/png?text=Dairy-Free+Scanner" width={500} height={1000} alt="Dairy-Free Scanner App" className="rounded-2xl mx-auto" />
      </div>
    </div>
  );
}