// app/solutions/allergy/page.tsx
    ...
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <div className="text-center md:text-left">
        ...
        <h1 className="text-6xl font-bold text-white leading-tight mb-6">
          Instant allergy detection built for busy families
        </h1>
        <p className="text-lg text-gray-300 mb-8">
          Effortlessly scan groceries and even bottled water to reveal hidden ingredients. Olive is accurate, fast, and designed to give busy parents the clarity they need.
        </p>
      ...
      {/* Right Column: Image */}
      <div>
        <Image src="https://placehold.co/500x1000/000000/FFFFFF/png?text=Allergy+Scanner+App" width={500} height={1000} alt="Allergy Scanner App" className="rounded-2xl mx-auto" />
      </div>
    </div>
  );
}