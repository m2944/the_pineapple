    ...
    <>
        ...
        <div className="mt-16">
          <div className="mb-16">
            ...
            <p className="text-white/80 mt-8 text-lg max-w-2xl mx-auto">
              Welcome to The Pineapple. The simplest, most elegant way to understand your diet and achieve your health goals. No noise, just results.
            </p>
          ...
          <div className="bg-gray-900 border-8 border-gray-800 rounded-3xl p-2 w-full max-w-sm mx-auto">
               <Image 
                ...
                width={400}
                height={800}
                alt="A screenshot of the Pineapple app's user interface inside a phone mockup."
      ...
      <section className="w-full flex flex-col items-center text-center md:text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
          <div>
            <Image src="https://placehold.co/600x400/000000/FFFFFF/png?text=App+Screenshot+Here" width={600} height={400} alt="A screenshot of the Pineapple app's user interface." className="rounded-xl shadow-lg" />
          </div>
      ...
      <section className="w-full flex flex-col items-center text-center mt-20">
        ...
        <div className="w-full max-w-3xl">
          ...
          <FaqItem question="Is the food database verified?" answer="Our food database is curated from verified sources, including national food databases and certified nutritionists. We prioritize accuracy to ensure you&apos;re logging." />
        </div>
      </section>
